...
class Main {
    public static void main(String[] args) throws ParserConfigurationException, SAXException, IOException {
        ...
        String PATH_TO_DB = "jdbc:sqlite:" + args[0];   // jdbc:sqlite:..\\stackoverflow.db
        String target_dir = args[1];   // ..\data\raw
...
//        saxParser.parse(target_dir + File.separator + "stackoverflow.com-Tags\\tags.xml", tagsHandler);
//
//        // Users
...
//        saxParser.parse(target_dir + File.separator + "stackoverflow.com-Users\\users.xml", usersHandler);
//
//        // Posts
...
//        saxParser.parse(target_dir + File.separator + "stackoverflow.com-Posts\\posts.xml", postsHandler);
//
//        // Comments
...
//        saxParser.parse(target_dir + File.separator + "stackoverflow.com-Comments\\comments.xml", commentsHandler);
        ...
        saxParser.parse(target_dir + File.separator + "stackoverflow.com-Badges\\badges.xml", badgesHandler);
...
//        saxParser.parse(target_dir + File.separator + "stackoverflow.com-Votes\\votes.xml", votesHandler);
